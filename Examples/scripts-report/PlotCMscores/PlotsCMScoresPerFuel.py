...
loc = '/Users/anobili/Downloads/Nobili-last-gas.csv' # report downloaded from SciExpeM ('Analysis' section)
fuel = 'H2'
...
#filter fuel
mask = (data['Fuel 1'] == fuel) | (data['Fuel 2'] == fuel) | (data['Fuel 3'] == fuel)
data = data[mask]
...
str_to_remove = [fuel,np.nan]
mixtures = [s for s in fuels if s not in str_to_remove]
...
if plots_report == True:
    ...
    data_spec['Target'] = data_spec['Target'].str.replace('_x','')
    ...
    plt.grid(True)
    if data_spec['Target'].unique().size > targets_length:
        sns.scatterplot(x='Target',y='Score',data=data,marker='o',facecolors='none',edgecolors='blue')
    ...
    plt.grid(True)
    sns.scatterplot(x='Temperature min',y='Score',data=data,marker='o',facecolors='none',edgecolors='blue')
    ...
    plt.xlim(data['Temperature min'].min(), data['Temperature max'].max())
    plt.grid(True)
    sns.scatterplot(x='Temperature max',y='Score',data=data,marker='o',facecolors='none',edgecolors='blue')
    plt.xticks(tick_positions)
    ...
    plt.ylim(0,1)
    plt.grid(True)
    sns.scatterplot(x='Pressure min',y='Score',data=data,marker='o',facecolors='none',edgecolors='blue')
    ...
    plt.ylim(0,1)
    plt.grid(True)
    sns.scatterplot(x='Phi min',y='Score',data=data,marker='o',facecolors='none',edgecolors='blue')
    ...
    plt.savefig(f'/Users/anobili/Desktop/fuels/{fuel}.pdf',dpi=300)
    plt.show()
