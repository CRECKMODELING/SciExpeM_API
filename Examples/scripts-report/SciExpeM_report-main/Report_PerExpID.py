...
ID_ChemModels = [641, 777]
labels = ['NATPROT-FINAL', 'NEWHEPT']
#exps_type =  ['outlet concentration measurement']
exps_type =  ['jet stirred reactor measurement']#,'ignition delay measurement', 'laminar burning velocity measurement']
...
savepath = r'/Volumes/My Passport/POLI/OPENSMOKE/ALKANES/NC7'
